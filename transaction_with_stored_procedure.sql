-- Bessere Lösung für das Tranksaktionsproblem: Eine einzige Stored Procedure
...
BEGIN
  ...
  IF form_id IS NULL THEN
    ...
    VALUES (form_name, form_description, form_category_id)
  ...
  question_index := 0;
  FOR question_data IN SELECT * FROM jsonb_array_elements(questions)
  LOOP
...
GRANT EXECUTE ON FUNCTION save_billing_form TO authenticated; 