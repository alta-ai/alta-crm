...
interface ProstateMRIGuidedBiopsyProps {
	onRender?: () => void;
}
...
export const ProstateMRIGuidedBiopsy: React.FC<ProstateMRIGuidedBiopsyProps> = (
	props
) => {
	const {
		appointmentData,
			...
			<BaseFormPage customStyle={{ fontSize: "8px" }}>
				<Header>
					...
					<Text style={styles.SubHeading}>
						für 3D live MRT-gesteuerte Prostatabiopsie
					</Text>
				</Header>
				...
				<View style={{ fontStyle: "italic" }}>
					...
					<Text>
						Die Gewebeproben werden durch einen Pathologen begutachtet und
						zusätzlich gemäß der GOÄ abgerechnet. Bei gesetzlich versicherten
						Patienten, die eine Überweisung für die Pathologie vorlegen, rechnet
						das Institut für Pathologie des Universititätsklinikums Hamburg
						Eppendorf mit der GKV ab. Bei gesetzlich versicherten Patienten, die
						keine Überweisung für die Pathologie vorlegen, rechnet das Institut
						für Pathologie des Universititätsklinikums Hamburg Eppendorf mit dem
						Patienten direkt ab. Alle anderen Patienten erhalten eine Rechnung
						von der ALTA Klinik.
					</Text>
				</View>
