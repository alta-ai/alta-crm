...
interface ProstateMRICEFormTULSASZProps {
	onRender?: () => void;
}
...
const TABLE_DATA = [
	{
		goa: "5720",
		text: "multiparametrische MRT der Prostata nach Behandlung",
		coeff: "1,100",
		price: "282,11",
	},
	{
...
export const ProstateMRICEFormTULSASZ: React.FC<
	ProstateMRICEFormTULSASZProps
> = (props) => {
	const {
		appointmentData,
		patientData,
		...
		<Document style={styles.Page} onRender={props?.onRender}>
			<BaseFormPage customStyle={{ fontSize: "10px" }}>
				<Header>
					...
					<Text style={styles.SubHeading}>der Prostata nach Behandlung</Text>
				</Header>
				...
				<View style={{ fontStyle: "italic", marginBottom: "85px" }}>
