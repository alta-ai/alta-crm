...
interface ProstateMRICEFormTULSAKVBProps {
	onRender?: () => void;
}
...
export const ProstateMRICEFormTULSAKVB: React.FC<
	ProstateMRICEFormTULSAKVBProps
> = (props) => {
	const {
		appointmentData,
		patientData,
		...
		<Document style={styles.Page} onRender={props?.onRender}>
			<BaseFormPage customStyle={{ fontSize: "9px" }}>
				<Header>
					...
					<Text style={styles.SubHeading}>
						der Prostata und des gesamten Beckens (KVB I-III)
					</Text>
				</Header>
