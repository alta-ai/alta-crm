...
interface ProstateMRIGuidedBiopsyKVBProps {
	onRender?: () => void;
}
...
export const ProstateMRIGuidedBiopsyKVB: React.FC<
	ProstateMRIGuidedBiopsyKVBProps
> = (props) => {
	const {
		appointmentData,
		patientData,
			...
			<BaseFormPage customStyle={{ fontSize: "8px" }}>
				<Header>
					...
					<Text style={styles.SubHeading}>
						für MRT-gesteuerte Prostatabiopsie (KVB I-III)
					</Text>
				</Header>
