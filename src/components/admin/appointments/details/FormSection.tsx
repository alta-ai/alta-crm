...
const FormSection: React.FC<FormSectionProps> = ({
  ...
  if (showPDFPreview) {
    ...
    const formData = formSubmission ? {
      urologicInformation: {
        currentlyUndergoingTreatment: formSubmission.current_treatment === 'true',
        recommendationOfUrologist: formSubmission.treatment_recommendations?.join(', '),
        visitDueToRecommendation: formSubmission.doctor_recommendation === 'true',
        nameOfUrologist: formSubmission.referring_doctor_name,
        gotTransfer: formSubmission.has_transfer === 'true',
        sendReportToUrologist: formSubmission.send_report_to_doctor === 'true'
      }
    } : {};
    ...
    const patientData = {
      ...
      insurance: {
        privateInsurance: formSubmission?.insurance_type === 'Private Krankenversicherung (PKV)' 
      ...
      <div className="mt-6 mb-10">
        ...
        <div className="grid grid-cols-2 gap-8 mt-6">
          <div>
            ...
            <p>{format(new Date(appointmentDate), "EEEE, d. MMMM yyyy 'um' HH:mm 'Uhr'", { locale: de })}</p>
          </div>
          <div>
