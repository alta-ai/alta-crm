-- Finale Version der gespeicherten Prozedur mit korrigierten Array-Indizes
  ...
  LOOP
    ...
    LOOP
      ...
      VALUES (
        ...
        NULLIF(option_data->>'billing_code_id', '')::uuid,  -- NULLIF damit leere Strings zu NULL werden
        option_index,
