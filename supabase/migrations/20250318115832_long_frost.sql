...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'document_categories') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'appointment_documents') THEN
