/*
  ...
  1. Changes
    ...
    - Enable RLS with unique policy names
    
  2. Security
    - Enable RLS on all tables
    - Add unique policies for each table
*/
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'registration_form_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "registration_form_submissions_select" ON registration_form_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "registration_form_submissions_insert" ON registration_form_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "registration_form_submissions_update" ON registration_form_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "registration_form_submissions_delete" ON registration_form_submissions
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'cost_reimbursement_form_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "cost_reimbursement_form_submissions_select" ON cost_reimbursement_form_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "cost_reimbursement_form_submissions_insert" ON cost_reimbursement_form_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "cost_reimbursement_form_submissions_update" ON cost_reimbursement_form_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "cost_reimbursement_form_submissions_delete" ON cost_reimbursement_form_submissions
        FOR DELETE TO public USING (true);
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'privacy_form_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "privacy_form_submissions_select" ON privacy_form_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "privacy_form_submissions_insert" ON privacy_form_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "privacy_form_submissions_update" ON privacy_form_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "privacy_form_submissions_delete" ON privacy_form_submissions
        FOR DELETE TO public USING (true);
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'examination_form_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "examination_form_submissions_select" ON examination_form_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "examination_form_submissions_insert" ON examination_form_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "examination_form_submissions_update" ON examination_form_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "examination_form_submissions_delete" ON examination_form_submissions
        FOR DELETE TO public USING (true);
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'ct_consent_form_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "ct_consent_form_submissions_select" ON ct_consent_form_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "ct_consent_form_submissions_insert" ON ct_consent_form_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "ct_consent_form_submissions_update" ON ct_consent_form_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "ct_consent_form_submissions_delete" ON ct_consent_form_submissions
        FOR DELETE TO public USING (true);
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'ct_therapy_form_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "ct_therapy_form_submissions_select" ON ct_therapy_form_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "ct_therapy_form_submissions_insert" ON ct_therapy_form_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "ct_therapy_form_submissions_update" ON ct_therapy_form_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "ct_therapy_form_submissions_delete" ON ct_therapy_form_submissions
        FOR DELETE TO public USING (true);
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'mrt_ct_consent_form_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "mrt_ct_consent_form_submissions_select" ON mrt_ct_consent_form_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "mrt_ct_consent_form_submissions_insert" ON mrt_ct_consent_form_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "mrt_ct_consent_form_submissions_update" ON mrt_ct_consent_form_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "mrt_ct_consent_form_submissions_delete" ON mrt_ct_consent_form_submissions
        FOR DELETE TO public USING (true);
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'prostate_questionnaire_submissions') THEN
    ...
    -- Create policies
    CREATE POLICY "prostate_questionnaire_submissions_select" ON prostate_questionnaire_submissions
        FOR SELECT TO public USING (true);

    CREATE POLICY "prostate_questionnaire_submissions_insert" ON prostate_questionnaire_submissions
        FOR INSERT TO public WITH CHECK (true);

    CREATE POLICY "prostate_questionnaire_submissions_update" ON prostate_questionnaire_submissions
        FOR UPDATE TO public USING (true) WITH CHECK (true);

    CREATE POLICY "prostate_questionnaire_submissions_delete" ON prostate_questionnaire_submissions
        FOR DELETE TO public USING (true);
